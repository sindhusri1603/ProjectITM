...
const classroomCoords = { lat: 53.5603964, lon: -113.4455089 };  // Classroom coordinates
        const allowedRadius = 3;  // Allowed radius in meters
        function getLoc() {
            ...
            navigator.geolocation.getCurrentPosition(
                (position) => {
                    ...
                    if (distance <= allowedRadius) {
                        ...
                        document.getElementById('message').innerText = "You must be within the classroom area (15 meters) to mark attendance.";
                    }
                },
                (error) => {
